...
use crate::{WuiTypeId, app::WuiAndroidAppHandles};
...
unsafe extern "system" fn Java_dev_waterui_android_ffi_WatcherJni_forceAsWebView<'local>(
    ...
    super::with_env(&mut env, |env| {
        ...
        unsafe {
            let view_ptr: *mut crate::WuiAnyView = crate::jni::convert::jlong_to_ptr_mut(view_ptr);
            ...
            let ffi = crate::IntoFFI::into_ffi(view.into_inner());
