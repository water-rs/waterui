...
pub extern "system" fn Java_dev_waterui_android_ffi_WatcherJni_dropBindingSecure<'local>(
    ...
    unsafe { drop(Box::from_raw(binding_ptr as *mut WuiBinding<waterui::Str>)) };
}
...
pub extern "system" fn Java_dev_waterui_android_ffi_WatcherJni_readComputedStr<'local>(
    ...
    use waterui::Signal;
    let computed = unsafe { &*(computed_ptr as *const WuiComputed<waterui::Str>) };
...
pub extern "system" fn Java_dev_waterui_android_ffi_WatcherJni_readComputedPickerItems<'local>(
    ...
    let computed = unsafe { &*(computed_ptr as *const WuiComputed<Vec<PickerItem<Id>>>) };
    ...
    for (i, item) in items.into_iter().enumerate() {
        ...
        let styled_str = {
            use waterui_text::styled::StyledStr;
            let computed = unsafe { &*(content_ptr as *const WuiComputed<StyledStr>) };
            computed.get()
        };
...
pub extern "system" fn Java_dev_waterui_android_ffi_WatcherJni_readComputedMenuItems<'local>(
    ...
    let computed = unsafe { &*(computed_ptr as *const WuiComputed<MenuItems>) };
...
pub extern "system" fn Java_dev_waterui_android_ffi_WatcherJni_readComputedRegion<'local>(
    ...
    let computed = unsafe { &*(computed_ptr as *const WuiComputed<Region>) };
...
pub extern "system" fn Java_dev_waterui_android_ffi_WatcherJni_readComputedAnnotations<'local>(
    ...
    let computed = unsafe { &*(computed_ptr as *const WuiComputed<Vec<Annotation>>) };
...
>(
    ...
    let computed = unsafe { &*(computed_ptr as *const WuiComputed<LivePhotoSource>) };
...
pub extern "system" fn Java_dev_waterui_android_ffi_WatcherJni_readComputedDate<'local>(
    ...
    let computed = unsafe { &*(computed_ptr as *const WuiComputed<Date>) };
...
unsafe extern "C" fn watcher_call_picker_items(
    ...
    for (i, item) in items_slice.iter().enumerate() {
        ...
        use waterui::Signal;
        use waterui_text::styled::StyledStr;
        let computed = unsafe { &*(content_ptr as *const crate::reactive::WuiComputed<StyledStr>) };
