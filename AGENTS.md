...
- Use `waterui-agent-workspace` for non-trivial repository implementation work. Use the `waterui` skill only when authoring WaterUI app/example code or checking public user-facing API usage.
