/// A macro for creating configurable views.
///
/// This macro creates a view struct that wraps a configuration type and implements
/// necessary traits for it to work as a configurable view in the WaterUI framework.
#[macro_export]
macro_rules! configurable {
    ($view:ident,$config:ty) => {
        /// A configurable view wrapper for a specific configuration type.
        ///
        /// This struct is automatically generated by the `configurable!` macro.
        #[derive(Debug)]
        #[must_use]
