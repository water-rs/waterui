...
## [0.5.2](https://github.com/water-rs/waterui/compare/v0.5.1...v0.5.2) - 2026-09-22

### Fixed

- pin the GTK backend to its registry release so stable projects can use it

### Other

- stop a CI-only commit from proposing a whole-workspace release
- publish the framework manifest for a tag that lost it
