...
- Linux GitHub Actions jobs that compile the workspace with all features must install `nasm` before running Cargo. `rav1e` enables assembly in those builds and fails fast without the assembler.
