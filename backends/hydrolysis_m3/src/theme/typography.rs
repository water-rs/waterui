...
mod tests {
    ...
    #[test]
    fn font_slots_match_m3_reference_type_scale() {
    ...
    #[test]
    fn label_large_matches_m3_reference_label_large() {
    ...
    #[test]
    fn label_medium_matches_m3_reference_label_medium() {
        let env = Environment::new();
    ...
    #[test]
    fn label_small_matches_m3_reference_label_small() {
        let env = Environment::new();
    ...
    #[test]
    fn body_medium_matches_m3_reference_body_medium() {
        let env = Environment::new();
    ...
    #[test]
    fn body_large_matches_m3_reference_body_large() {
        let env = Environment::new();
    ...
    #[test]
    fn body_small_matches_m3_reference_body_small() {
        let env = Environment::new();
    ...
    #[test]
    fn title_small_matches_m3_reference_title_small() {
        let env = Environment::new();
