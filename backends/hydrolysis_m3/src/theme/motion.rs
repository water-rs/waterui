...
/// MD3 interaction state-layer motion, matching the M3 reference
...
mod tests {
    ...
    #[test]
    fn material_state_layer_motion_matches_m3_reference() {
        ...
        // ripple finishes expanding before it starts to fade (the M3 reference waits for
    ...
    #[test]
    fn material_navigation_motion_matches_shared_axis_and_m3_tokens() {
    ...
    #[test]
    fn material_navigation_drawer_motion_matches_m3_reference() {
    ...
    #[test]
    fn material_tooltip_motion_matches_m3_reference() {
        assert_eq!(
            tooltip(),
            Animation::bezier(Duration::from_millis(200), 0.2, 0.0, 0.0, 1.0)
        );
    ...
    #[test]
    fn material_dialog_motion_selects_m3_directional_curves() {
        let opened = Binding::bool(false);
