...
/// Gap between the track's left edge and the unselected thumb (the M3 reference `left: 6`
/// with a 16dp thumb puts the resting center at 14dp).
pub const TOGGLE_SWITCH_THUMB_UNSELECTED_INSET: f64 = 6.0;
/// Gap between the track's right edge and the selected thumb (the M3 reference `left: 24`
