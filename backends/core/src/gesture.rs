...
/// How far, in logical points, a press may drift from where it started before a
/// long press fails. Backends that recognise a platform hold gesture outside the
/// gesture engine (a touch hold that opens a context menu) use the same slop.
