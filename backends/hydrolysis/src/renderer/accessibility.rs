...
#[cfg(feature = "accessibility")]
pub(super) const ACCESSIBILITY_FIRST_NODE_ID: u64 = 1;
...
#[cfg(feature = "accessibility")]
pub(super) struct AccessibilityBuilder {
    ...
    pub(super) root_bounds: vello::kurbo::Rect,
    pub(super) root_label: String,
    pub(super) focus: AccessibilityNodeId,
    pub(super) pending_text_input_nodes: VecDeque<AccessibilityNodeId>,
    pub(super) suppression_depth: usize,
    pub(super) pending_tree_update: Option<AccessibilityTreeUpdate>,
}
...
impl AccessibilityBuilder {
    ...
    pub(super) fn swap_render_state(
        &mut self,
    ...
    pub(super) fn next_node_id(&mut self) -> AccessibilityNodeId {
    ...
    pub(super) fn push_pending_text_input_node(&mut self, node_id: AccessibilityNodeId) {
        self.pending_text_input_nodes.push_back(node_id);
    }

    pub(super) fn take_pending_text_input_node(&mut self) -> Option<AccessibilityNodeId> {
        self.pending_text_input_nodes.pop_front()
    }

    pub(super) fn push_suppression(&mut self) {
    ...
    pub(super) fn pop_suppression(&mut self) {
        self.suppression_depth = self
            .suppression_depth
            .checked_sub(1)
    ...
    pub(super) fn apply_state(&self, env: &Environment, node: &mut AccessibilityNode) {
    ...
    pub(super) fn register_node_internal(
        &mut self,
    ...
    pub(super) fn finalize_tree_update(&mut self) {
...
impl HydrolysisRenderer {
    #[cfg(feature = "accessibility")]
    pub(super) fn next_accessibility_node_id(&mut self) -> AccessibilityNodeId {
        self.accessibility.next_node_id()
    }

    #[cfg(feature = "accessibility")]
    pub(super) fn replay_dynamic_accessibility_subtree(
        &mut self,
    ...
    #[cfg(feature = "accessibility")]
    pub(super) fn take_pending_text_input_accessibility_node(
        &mut self,
    ) -> Option<AccessibilityNodeId> {
    ...
    #[cfg(feature = "accessibility")]
    pub(super) fn push_accessibility_suppression(&mut self) {
        self.accessibility.push_suppression();
    }

    #[cfg(feature = "accessibility")]
    pub(super) fn pop_accessibility_suppression(&mut self) {
    ...
    #[cfg(feature = "accessibility")]
    pub(super) fn finalize_accessibility_tree_update(&mut self) {
