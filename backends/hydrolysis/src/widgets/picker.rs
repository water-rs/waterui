...
pub(crate) fn render_menu_picker(
    ...
    let text_bounds =
        super::util::inset_rect(ctx.bounds, metrics.horizontal_inset, metrics.vertical_inset);
    ...
    for (index, item) in items.into_iter().enumerate() {
        ...
        let row_text_rect =
            super::util::inset_rect(row_rect, metrics.horizontal_inset, metrics.vertical_inset);
        ctx.render_styled_text(
