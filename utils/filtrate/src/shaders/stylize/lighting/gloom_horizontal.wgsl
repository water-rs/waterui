// Gloom, first (horizontal) pass: extracts thresholded highlight energy and
// box-accumulates it horizontally (gloom dulls highlights, so it spreads
// the same energy bloom does and subtracts it in the second pass).
//
...
// effect — a fully sub-threshold neighbourhood contributes exactly zero.
//
