// Separable horizontal blur pass.
// Writes to intermediate storage texture.
    ...
    if all(input_dims_u == dims) {
        ...
        loop {
            ...
            loop {
                ...
                let sample_x = clamp(
                    group_origin_x + segment_start + load_x,
                    0,
                    input_dims_i.x - 1,
                );
                tile_rows[local_id.y][u32(load_x)] =
                    textureLoad(input_texture, vec2<i32>(sample_x, output_y), 0);
            ...
            loop {
                ...
                sum += tile_rows[local_id.y][u32(base + offset)];
                offset += 1;
            }
