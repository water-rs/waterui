...
impl<F: Filter> FilterAdapter<F> {
    fn create_color_pipeline(
        ...
        let preamble = include_str!(concat!(
            ...
            "/../../../utils/filtrate/src/shaders/shared/fragment_preamble.wgsl"
        ));
        let postamble = include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/../../../utils/filtrate/src/shaders/shared/fragment_postamble.wgsl"
        ));
...
mod tests {
    ...
    impl Filter for HugeFilter {
        ...
        fn fragments(&self) -> Self::Fragments {
            include_str!(concat!(
                env!("CARGO_MANIFEST_DIR"),
                "/../../../utils/filtrate/src/shaders/color/adjustment/brightness.wgsl"
            ))
        }
    ...
    fn hdr_color_fragments_do_not_clamp_to_unit_range() {
        ...
        let contrast = include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/../../../utils/filtrate/src/shaders/color/adjustment/contrast.wgsl"
        ));
