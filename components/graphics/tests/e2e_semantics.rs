...
fn assert_image_node(app: &mut MountedApp, case: &str, label: &str) {
...
fn linear_gradient_exposes_accessibility_image(app: &mut MountedApp) {
    assert_image_node(
        app,
...
fn animated_mesh_gradient_exposes_accessibility_image(app: &mut MountedApp) {
    assert_image_node(
        app,
...
fn shader_surface_exposes_accessibility_image(app: &mut MountedApp) {
    assert_image_node(
        app,
