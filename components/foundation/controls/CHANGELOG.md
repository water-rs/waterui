...
## [0.5.0](https://github.com/water-rs/waterui/compare/controls-v0.3.2...controls-v0.5.0) - 2026-09-20
...
- *(button)* add Glass and GlassProminent button styles
...
## [0.3.2](https://github.com/water-rs/waterui/compare/controls-v0.3.1...controls-v0.3.2) - 2026-09-11
...
## [0.3.1](https://github.com/water-rs/waterui/compare/controls-v0.3.0...controls-v0.3.1) - 2026-09-11

### Other

- updated the following local packages: waterui-core, waterui-layout, waterui-text, waterui-locale, waterui-icon

## [0.3.0](https://github.com/water-rs/waterui/compare/controls-v0.2.1...controls-v0.3.0) - 2026-08-25

### Changed

- Remove `RichTextField` alias; use `TextField::styled(&Binding<StyledStr>)` for field-style rich text input and keep `RichTextEditor` as the editor API.
