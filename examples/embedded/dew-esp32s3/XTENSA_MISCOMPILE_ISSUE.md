...
| Toolchain esp 1.94.0.2 | fat LTO: compiler ICE `rustc-LLVM ERROR: Unexpected node to lower`; opt "s": firmware boot-loops before reaching `main` | fails differently |
